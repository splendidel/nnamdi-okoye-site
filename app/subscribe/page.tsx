          ...
          <div className="space-y-10">
            <section>
              ...
              <div className="text-slate-500 dark:text-slate-400 space-y-8">
                <p className="text-lg">
                  Connecting with me on social media is a great way to stay updated on my latest projects, insights, and activities. Follow me on these platforms to engage with my content, share your thoughts, and be part of the conversation.
                </p>
