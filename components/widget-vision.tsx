export default function WidgetVision() {
  return (
    <div className="rounded-lg border border-slate-200 dark:border-slate-800 dark:bg-linear-to-t dark:from-slate-800 dark:to-slate-800/30 odd:rotate-1 even:-rotate-1 p-5">
      ...
      <div className="font-aspekta font-[650] mb-1">Vision</div>
      <p className="text-sm text-slate-500 dark:text-slate-400">A New Generation for Anambra State...</p>
    </div>
  )
}